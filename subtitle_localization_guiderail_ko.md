...
1. **Corrected Korean SRT File** — same structure, indices, and timecodes as the input; only the subtitle text is corrected. Never alter timecodes or block numbering.
